...
public class ChatListAdapter extends ArrayAdapter<Message> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final boolean isMe = message.getUser()!=null && message.getUser().equals(mUserId);
        ...
        Picasso.with(getContext()).load(getProfileUrl(message.getProfileUrl())).into(profileView);
